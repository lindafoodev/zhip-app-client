  ...
  render() {
    ...
    const transactions = this.props.transactionsList.map(transaction => (
      <li className='transactions-list-transaction' key={transaction._id}>
          <div className='transaction-container info-container'>
            <div className='transactions-list-transaction-id'><span className='key-name'>IOU #</span><br/>{transaction._id}</div>
            <div className='transactions-list-transaction-amount'><span className='key-name'>Amount</span><br/>{transaction.transactionAmount}</div>
          </div>
      </li>
  ));
